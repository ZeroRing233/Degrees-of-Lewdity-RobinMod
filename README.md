...
如果你的游戏本体已更新到0.5.3.x，请下载[0.06-for-dol-0.5.3](https://github.com/ZeroRing233/Degrees-of-Lewdity-RobinMod/releases/tag/0.06-for-dol-0.5.3)，其他版本与0.5.3.x均无法兼容。
...
<ol>
    ...
    <li>开放与气球摊老板合作状态下售卖气球和爆米花的方式。（暂定为合作达到一定规模后一起说服老板）</li>
