...
4. （泰拉瑞亚联动）可以在海滩和罗宾一起卖烤鱼（一共十三种鱼类可售卖）/岩石龙虾/绿波泥鳅，可在日志中查看当前拥有的可食用渔获列表，**联动剧情需安装**[泰拉瑞亚模组](https://github.com/Nephthelana/DOL-Terra-Expanding-Modd)。
...
8.  为高希望/高叛逆时的孤儿院大厅海报添加cg，可在通用-设置里选择是否开启海报/海报风格/大小，修改设置后需等下次海报事件才会生效。（cg作者：贴吧用户_Gy3a33a）
...
6. 获取特质「贝利的反抗者后」，罗宾可以和pc一起帮助其他孤儿找工作（如管理柠檬水店），从而达到兼济天下（？）的效果
