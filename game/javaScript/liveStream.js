...
setup.random_msg = {
    ...
    neutral_list: ["主播主播，这是直播吗？", "在播什么呀？", '不错，继续看看。', "主播在忙什么呢？", "看起来挺有趣的", "画面挺清晰的", "直播挺流畅的", "节奏把握得不错。", "挺有新意的直播", "期待更多内容", "内容有一点无聊", "内容有一点平淡"],
    negative_list: ["这播得是什么东西", "无聊，来播点更刺激的东西吧", "把你的衣服脱了", "垃圾主播，趁早改行吧", "傻X", "脑残主播", "装什么纯洁呢，看看你的", "这不是有手就行", "主播有一点菜", "感觉我上我也行"]
}
...
function checkFame() {
    ...
    if (V.fame.good >= 600) {
        ...
        T.fixedChatFans.push("主播的<<robinFriend>>据说是个很善良的人。");
    }
